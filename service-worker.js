...
const CACHE_NAME = 'opotest-v38';
const FONT_CACHE = 'opotest-fonts-v1'; // fuentes de Google: se guardan aparte y sobreviven a las versiones de la app
const APP_SHELL = [
  './',
  './index.html',
  './style.css',
...
// - El resto de dominios externos (Firebase/Firestore/Auth, etc.) se dejan pasar sin interceptar.
